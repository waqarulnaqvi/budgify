            ...
            children: [
              ...
              ListView.builder(
                ...
                itemBuilder: (context, i) {
                  ...
                  IconData usedIcon = Icons.arrow_circle_up_outlined;
                  FaIconData? faIcon;
                  ...
                  switch (tl.trackerCategory) {
                    case 0:
                      usedIcon = Icons.arrow_circle_up_outlined;
                      colors = AppGradients.greenGradient;
                      break;
                    case 1:
                      usedIcon = Icons.arrow_circle_down_outlined;
                      colors = AppGradients.youtubeGradient;
                      break;
                    case 3:
                      usedIcon = Icons.receipt_long;
                      colors = AppGradients.youtubeGradient;
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                    ...
                                                    child: faIcon!= null ? FaIcon(faIcon, color: Colors.white,
                                                      size: 15, ) : Icon(
                                                      usedIcon,
                                                      color: Colors.white,
                                                      size: 15,
                                                ...
                                                Text("Type: ",
                                                    style: AppStyles
                                                        .descriptionPrimary(
                                                            ...
                                                            fontSize: 14)),
                                                if(faIcon!=null)
                                                FaIcon(faIcon, color: colors[0], size: 25 )
                                                else
                                                Icon(usedIcon,
